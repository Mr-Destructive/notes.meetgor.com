...
2. [If you’re going to vibe code, why not do it in C or even Assembly](https://stephenramsay.net/posts/vibe-coding.html)
...
3. [Why Transformers must hallucinate](https://nikitph.medium.com/why-transformers-must-hallucinate-7c2a8fc3b3be)
...
4. [Please don’t automate science](https://togelius.blogspot.com/2025/12/please-dont-automate-science.html)
    ...
    3. There are bangers after bangers  
    ...
    4. I want to quote each and every paragraph it seems, this is so good, almost like it comes out of my mouth  
...
8. [The Gemini API Key Frustration](https://ankursethi.com/blog/gemini-api-key-frustration/)
...
- [Software is getting worse](https://www.youtube.com/watch?v=FI5ba4RRE8U)Double click to interact with video
...
- [**Agentic AI Foundation Launched Under Linux Foundatio**](https://www.linuxfoundation.org/press/linux-foundation-announces-the-formation-of-the-agentic-ai-foundation)**n**
...
For more news, follow the [Hackernewsletter](https://buttondown.com/hacker-newsletter/archive/774/) (#774th edition), and for software development/coding articles, join [daily.dev](http://daily.dev/).
