...
- [Churning code was never the bottleneck](https://ordep.dev/posts/writing-code-was-never-the-bottleneck)
- Solving problems and understanding the business needs was the core goal.
...
- Advent of SQL 2025 in SQLite
    - [Day 11: Behavior Score](https://www.meetgor.com/sqlog/advent-of-sql-2025-day-11)
    - [Day 10: Misdelivered Presents](https://www.meetgor.com/sqlog/advent-of-sql-2025-day-10)
    - [Day 9: Evergreen Market Orders](https://www.meetgor.com/sqlog/advent-of-sql-2025-day-9)
    - [Day 8: Product Catalog](https://www.meetgor.com/sqlog/advent-of-sql-2025-day-8)
    - [Day 7: Polar Express Mixin](https://www.meetgor.com/sqlog/advent-of-sql-2025-day-7)
    - [Day 6: Days of Delight](https://www.meetgor.com/sqlog/advent-of-sql-2025-day-6)
    - [Day 5: EchoTrack Wrapped](https://www.meetgor.com/sqlog/advent-of-sql-2025-day-5)
...
1. [You’re not burning out, you’re essentially starving](https://neilthanedar.com/youre-not-burnt-out-youre-existentially-starving/)
  ...
  Just read the post!
2. [Don’t become the machine](https://armeet.bearblog.dev/becoming-the-machine/)
    1. This is well put.
...
3. [How I left youtube](https://zhach.news/how-i-left-youtube/)
    1. Man that was a good read!
    2. I resonated with this a lotThis duality is exhausting. It forces you to lie by omission to people you respect. You can’t tell your team, “I can’t take that ticket because I need to study dynamic programming.” You just have to work faster.
      ...
      Let’s see!
    3. Good lessons    - Don’t say: “I tweaked the YouTube watch-time algorithm using X variable.
      ...
      Man!!My final conversation with my manager was heart-wrenching. I had prepared a script, anticipating a counter-offer or a guilt trip. Instead, I was met with soft and understanding empathy.
      YepThe interview fatigue is real, and the conversations are hard, but the clarity you gain on your own value is worth the struggle.
    4. Got to go through it once and then there would be no stop for growth.
      Grass looks green on the other side always! Damm
4. [Text editors should be worse](https://www.da.vidbuchanan.co.uk/blog/annoying-text-editors.html)
...
6. [Writing HTML by hand is easier and cheaper then debugging your SSG in 2025](https://logicgrimoire.wordpress.com/2024/07/01/writing-html-by-hand-is-easier-than-debugging-your-static-site-generator/)
...
9. [Vibe Coding is broring](https://cassidoo.co/post/vibe-coding-yawn/)
...
For more news, follow the [Hackernewsletter](https://buttondown.com/hacker-newsletter/archive/775/) (#775th edition), and for software development/coding articles, join [daily.dev](http://daily.dev/).

But here’s my wrap in 2025

- Wrote 52 articles from [#23](https://techstructively.substack.com/p/techstructive-weekly-23) all the way to [#74](https://techstructively.substack.com/p/techstructive-weekly-74)
- Wrote 50+ articles on SQL on [#sqlog](https://www.meetgor.com/sqlog/)
