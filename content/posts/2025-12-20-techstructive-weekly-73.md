...
I have continued to write Advent of SQL for the past 4 days, and brought back the streak of writing [SQLog](https://meetgor.com/sqlog). I was not able to ship some code over the past weekend. But this weekend, I am pumped. I have time sorted out. Would be shipping some improvements in the website. Oh! I actually added snowball and particles based on season on [my website](meetgor.com) (only index and post pages).
...
1. Advent of SQL 2025 on [databaseschool.com](http://databaseschool.com)
    ...
    3. [Day 3: Hotline Messages](https://www.meetgor.com/sqlog/advent-of-sql-2025-day-3/)
        
    4. [Day 4: Winterfest Volunteers](https://www.meetgor.com/sqlog/advent-of-sql-2025-day-4/)
...
* If you want to merge two tables, you need to use `UNION`to make sure duplicates are discarded.
...
* Google Releases
    ...
    * [Gemini 3 Flash](https://blog.google/technology/developers/build-with-gemini-3-flash/)
    ...
    * [Function Gemma](https://blog.google/technology/developers/functiongemma/)
    ...
    * [T5Gemma2](https://blog.google/technology/developers/t5gemma-2/)
...
* [Astral launches ty, a fast Python type checker and LSP](https://astral.sh/blog/ty)
...
[Leave a comment](https://www.meetgor.com/newsletter/techstructive-weekly-73/%25%25half_magic_comments_url%25%25)

[Share Techstructive Weekly](https://www.meetgor.com/newsletter/techstructive-weekly-73/%25%25share_pub_url%25%25)
