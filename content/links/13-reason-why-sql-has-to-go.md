...
preview_description: Why is the language developers and DBAs use to organize data
  such a mess? Here are 13 reasons we wish we could quit SQL, even though we probably
  won't.
