---
title: "Curl uses `@`  for indicating a file upload"
date: 2026-01-24
draft: false
---

# Curl uses `@`  for indicating a file upload

**Link:** https://stackoverflow.com/questions/12667797/using-curl-to-upload-post-data-with-files
